...
//    private final ConcreteKafkaProducer<String, SpecificRecord> producer;
//    private final String topic;
//    public TaskScenario(String scenarioName, EnvironmentConfigLoader config, ConcreteKafkaConsumer<String, SpecificRecord> consumer, ConcreteKafkaProducer<String, SpecificRecord> producer, String topic) {
